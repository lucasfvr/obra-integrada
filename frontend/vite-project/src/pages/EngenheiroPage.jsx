    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
          <h1 className="text-2xl font-bold text-foreground mb-2">Engenharia</h1>
          <p className="text-sm text-muted-foreground mb-4">Área dedicada aos Engenheiros. Aqui estão ferramentas de validação técnica, listas de atividades e informações de obra.</p>

          <div className="rounded-lg bg-emerald-50 border border-emerald-100 p-5 text-emerald-700">
            <p className="font-semibold mb-2">Recursos de demonstração</p>
            <ul className="list-disc list-inside text-sm leading-relaxed">
              <li>Informações de projetos e obras</li>
              <li>Lista de atividades técnicas</li>
              <li>Validação de etapas e checklist</li>
            </ul>
          </div>
        </div>
      </div>
