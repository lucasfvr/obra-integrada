  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-20">
      ...
      <div className="mt-8 px-4 md:px-0 min-h-[400px]">
        ...
        {activeTab === 'diario'     && <div className="animate-slide-up"><ObraDiary initialEntries={obra.tb_diario_obra} idObra={id} team={obra.tb_usuario_obra} manager={obra.tb_usuario} onRefresh={fetchObraDetails} /></div>}
