...
import CadastroObra from "./CadastroObra.jsx";
                    ...
                    <>
                        <div className="flex justify-between items-center mb-6">
                            <h1 className="text-3xl font-bold text-slate-800">
                                Dashboard de {currentUser.username}
                            </h1>
                            <button
                                onClick={() => setIsCreatingObra(true)}
                                className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 rounded shadow font-medium"
                            >
                                + Nova Obra Completa
                            </button>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow">
                            <h2 className="text-2xl font-semibold mb-4 text-slate-700">
                                Calculadora de Materiais Básica
                            </h2>
