...
export const PERMISSOES = {
  ADMIN_MASTER: { plataforma: true,  obras: true,  criar_diario: true,  deletar_diario: true,  impersonar: true,  gerenciar_tarefas: true,  atualizar_status_tarefa: true  },
  MASTER:       { plataforma: true,  obras: true,  criar_diario: true,  deletar_diario: true,  impersonar: true,  gerenciar_tarefas: true,  atualizar_status_tarefa: true  },
  ADMIN:        { plataforma: true,  obras: true,  criar_diario: true,  deletar_diario: true,  impersonar: true,  gerenciar_tarefas: true,  atualizar_status_tarefa: true  },
  DEV:          { plataforma: true,  obras: false, criar_diario: false, deletar_diario: true,  impersonar: true,  gerenciar_tarefas: true,  atualizar_status_tarefa: true  },
  FIN:          { plataforma: true,  obras: false, criar_diario: false, deletar_diario: false, impersonar: false, gerenciar_tarefas: false, atualizar_status_tarefa: false },
  RH:           { plataforma: true,  obras: false, criar_diario: false, deletar_diario: false, impersonar: false, gerenciar_tarefas: false, atualizar_status_tarefa: false },
  SUPORTE:      { plataforma: true,  obras: false, criar_diario: false, deletar_diario: false, impersonar: false, gerenciar_tarefas: false, atualizar_status_tarefa: false },
  PROPRIETARIO: { plataforma: false, obras: true,  criar_diario: true,  deletar_diario: true,  impersonar: false, gerenciar_tarefas: true,  atualizar_status_tarefa: true  },
  ...
  RESPONSAVEL:  { plataforma: false, obras: true,  criar_diario: true,  deletar_diario: true,  impersonar: false, gerenciar_tarefas: true,  atualizar_status_tarefa: true  },
